...
// Interface Segregation Principle (ISP) states that clients should not be forced to depend on interfaces they do not use. In other words, a class should not be forced to implement methods that it does not need or use. This principle promotes the idea of creating smaller, more specific interfaces rather than large, general-purpose ones.
